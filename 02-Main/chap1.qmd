...
![Franz Kafka, Mann zwishen Gittern](../img/Mann_zwischen_Gittern.png){width="50%"}
...
[Structure of the Federal Courts]{.case-h1}
...
![Fig. 1.3](../img/FedCourtsMap.png)

[Appellate Courts]{.case-h2}
...
[United States Supreme Court]{.case-h2}
...
[Jurisdiction of the Federal Courts]{.case-h1}
...
[ Structure of State Courts]{.note-h1}

[Trial Courts]{.note-h2}

State trial courts go by a variety of names: Superior Court,[^state-courts1a] Circuit Court,[^state-courts1b] District Court, Court of Common Pleas (Ohio and Pennsylvania),[^state-courts1c] or Supreme Court.[^state-courts1d]

[^state-courts1a]: Alaska, Arizona, California, Connecticut, Delaware, District of Columbia, Georgia, Maine, Massachusetts, New Hampshire, New Jersey, North Carolina, Rhode Island, Vermont, and Washington.

[^state-courts1b]: Alabama, Arkansas, Florida, Hawaii, Illinois, Indiana, Kentucky, Maryland, Michigan, Mississippi, Missouri, Oregon, South Carolina, South Dakota, Tennessee, Virginia, West Virginia, and Wisconsin.

[^state-courts1c]: Colorado, Idaho, Iowa Kansas, Louisiana, Minnesota, Montana, Nevada, New Mexico, North Dakota, Oklahoma, Texas, and Utah. 

[^state-courts1d]: New York.

[Appellate Courts]{.note-h2}

Most states also have at least one intermediate appellate court, usually called the Court of Appeals[^state-courts2]. In some states,[^state-courts2a] the intermediate appellate court is divided into geographic districts, similar to the federal appellate circuits. Nine states [^state-courts2b] have no intermediate appellate court. Alabama and Tennessee have separate intermediate appellate courts for civil and criminal cases. Pennsylvania has a special intermediate appellate court (the Commonwealth Court) with jurisdiction over certain civil cases involving state and local government, and another (the Superior Court) for other civil appeals and all criminal appeals.

[^state-courts2]: Exceptions include the Superior Court, Appellate Division in New Jersey, the Supreme Court, Appellate Division in New York, and the Superior and Commonwealth Courts in Pennsylvania

[^state-courts2a]: Arizona, California, Florida, Illinois, Indiana, Louisiana, Missouri, New York, Ohio, Tennessee, Texas, Washington, and Wisconsin.

[^state-courts2b]: Delaware, Maine, Montana, New Hampshire, Rhode Island, South Dakota, Vermont, West Virginia and Wyoming.

The highest court in each state is usually called the Supreme Court, though some states use other names.[^state-courts3] Texas and Oklahoma each have two courts of last resort: a Supreme Court for civil cases and a Court of Criminal Appeals for criminal cases.

[^state-courts3]: e.g. Supreme Judicial Court in Massachusetts and Maine; Supreme Court of Appeals in West Virginia; Court of Appeals in New York, Maryland, and the District of Columbia.

[ Jurisdiction of State Courts]{.note-h2}
...
[II. Where Disputes Come From and How They Develop]{.case-h1}
...
[III. The Characteristics of Transformation]{.case-h1}
...
[IV. Subjects and Agents of Transformation]{.case-h1}
...
[Representatives and Officials]{.case-h2}
...
[§2071--Rule-making power generally]{.legal-code-h1}
...
[§2072--Rules of procedure and evidence; power to prescribe]{.legal-code-h1}
...
[§2073--Rules of procedure and evidence; method of prescribing]{.legal-code-h1}
...
[§2074--Rules of procedure and evidence; submission to Congress]{.legal-code-h1}
...
[Scope and Purpose]{.legal-code-h1}
...
[One Form of Action]{.legal-code-h1}
...
![Fig. 1.2](../img/CivilAction1.png)

![Fig. 1.3](../img/CivilAction2.png)
