...
#### [@CraneCityArlington2022]

[PATRICK E. HIGGINBOTHAM, Circuit Judge]{.case-judge}
...
- {{< bi dot >}} _Depositions_: recorded testimony of parties and other potential witnesses, either by oral examination ([Rule 30](https://www.law.cornell.edu/rules/frcp/rule_30)) or written questions ([Rule 31](https://www.law.cornell.edu/rules/frcp/rule_31)); deposition testimony may be admitted in court under certain conditions ([Rule 31](https://www.law.cornell.edu/rules/frcp/rule_32));
- {{< bi dot >}} _Interrogatories_: written questions directed to a party ([Rule 33](https://www.law.cornell.edu/rules/frcp/rule_33));
- {{< bi dot >}} _Requests for production of documents or things_ ([Rule 34](https://www.law.cornell.edu/rules/frcp/rule_34));
- {{< bi dot >}} _Physical and mental examinations of a party_ ([Rule 35](https://www.law.cornell.edu/rules/frcp/rule_35)); 
- {{< bi dot >}} _Requests for admission_ ([Rule 36](https://www.law.cornell.edu/rules/frcp/rule_36)).
...
[C\. Fourteenth Amendment Racial Profiling]{.case-h2}
...
[II\. Lack of Evidence of Fourteenth Amendment Violation]{.case-h1}
...
> - {{< bi dot >}} They were traveling from Memphis, Tennessee to Jackson, Mississippi, which are both predominantly black cities.
> 
> - {{< bi dot >}} They are both black.
> 
> - {{< bi dot >}} They were driving a Lexus SUV.
> 
> - {{< bi dot >}} Stout believed "they were being held because they are African American and for no other reason."
> 
> - {{< bi dot >}} Montgomery also believed "it appeared that the only reason Officer Vincent was keeping them was that they were black and driving a Lexus."
> 
> - {{< bi dot >}} Officer Vincent later remembered that Stout and Montgomery had indicated that the purpose of their trip to Mississippi was a concert when in fact they had told him they were in Mississippi for Stout's graduate student research. According to Stout and Montgomery, this lapse is evidence that Officer Vincent had discriminatory intent because "he did not see a highly educated Black woman and her partner; he saw two Black people in a nice car going to a concert."
> 
> - {{< bi dot >}} No trooper issued them a ticket or citation, even though the officers claim they found marijuana in the SUV.
> 
> - {{< bi dot >}} They both stated there was no marijuana in the car that day.
> 
> - {{< bi dot >}} On the day before Officer Vincent detained Appellants, the City of Mound Bayou approved a resolution against the racial profiling of people of color by the MHSP. The mayor of Winstonville also condemned racial profiling of black people by the MHSP. Officer Vincent has been with the MHSP since 1997.
...
[Summary of Sally Schlimazel Deposition Testimony]{.case-h1}
...
[Summary of Freddie Frankel Affidavit]{.case-h1}
...
[Summary of Milo Mebelmacher Deposition Testimony:]{.case-h1}
...
[Summary of Julius Hahn Deposition Testimony]{.case-h1}
