...
Click on the [{{< bi file-pdf >}}]{.theme-color} icon to download a PDF copy of the casebook.

Click on the [{{< bi github >}}]{.theme-color} icon to view the source code or report issues.[^issues]
