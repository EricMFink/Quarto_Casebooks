...
When viewing the online version, you can navitgate through the book using the menus in the left-hand sidebar. Use the upper menu to select a chapter and the lower menu to select a section or sub-section within the chapter. 

![Upper Navigation Menu](../img/casebook-menu1.png)

![Upper Navigation Menu](../img/casebook-menu2.png)
