...
Links to external material are indicated by dark red text, e.g. [Mayo v. Satan](../exhibits/Mayo_Satan.pdf).

Click on the [{{< bi file-pdf >}}]{.link-color} icon to download a PDF copy of the casebook.

Click on the [{{< bi github >}}]{.link-color} icon to view the source code or report issues.[^issues]
